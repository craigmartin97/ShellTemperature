...
namespace ShellTemperature.Data
{
    public class SdCardShellTemp
    {
        ...
        public SdCardShellTemp()
        {

        }

        public SdCardShellTemp(double temperature, DateTime? dateTime, float? latitude, float?
        ...
        public SdCardShellTemp(Guid id, double temperature, DateTime? dateTime, float? latitude, float?
            longitude, DeviceInfo deviceInfo)
